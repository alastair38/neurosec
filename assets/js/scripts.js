...
const dpdBtn = document.querySelectorAll('.dropdown-button');
...
$(document).ready(function () {
  ...
  $('.dropdown-button + .dropdown-content > li:last-child').focusout(
    function () {
...
var options = [
  {
    selector: '#more',
    offset: 50,
    callback: 'Materialize.fadeInImage("#starting")',
  },
];
