	...
	if($contactEmail) {
		echo '<div class="contact-details light"><strong>Contact: </strong>  <a class="tooltipped" data-position="right" data-delay="50" data-tooltip="Click to contact by email" href="mailto:' . $contactEmail . '" target="_blank">' . $contactName . '</a><br />';
	} if($contactPhone) {
